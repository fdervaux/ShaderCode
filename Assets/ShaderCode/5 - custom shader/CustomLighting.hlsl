    ...
    half clearCoatMask, bool specularHighlightsOff)
{
    ...
    {
        brdf += brdfData.specular * smoothstep(0.5,0.75,DirectBRDFSpecular(brdfData, normalWS, lightDirectionWS, viewDirectionWS)) * smoothstep(0,0.01,lightAttenuation * NdotL);
...
half4 UniversalFragmentPBR(InputData inputData, SurfaceData surfaceData)
{
    ...
    //lightingData.giColor = step(0.3 , lightingData.giColor.y) * lightingData.giColor; //step giColor
...
#endif
    {
        ...
        //step mainlightColor
        //float factor = smoothstep(0, 0.01, lightingData.mainLightColor.y) + smoothstep(0.6, 0.65, lightingData.mainLightColor.y) * 0.8;
        //lightingData.mainLightColor = factor;
    }
